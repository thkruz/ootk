 ...
 */
export function smooth(xs: number[], alpha: number): number[] {
  const ss: number[] = [];
 ...
 */
export function smoothDouble(xs: number[], alpha: number, beta: number): number[] {
  const bs: number[] = [];
  const ss: number[] = [];
 ...
 */
export function smoothTime(epochs: EpochUTC[], xs: number[], timeConstant: number): number[] {

/**
 * @file BatchLeastSquaresOD robustness test suite
 * @description Tests for convergence, robustness, numerical stability, and configuration
 */
...
/*
 * ============================================================================
 * Test Suite: Convergence Behavior
 * ============================================================================
 */

describe('BatchLeastSquaresOD - Convergence Behavior', () => {
...
describe('BatchLeastSquaresOD - Robustness', () => {
  const startEpoch = EpochUTC.fromDateTimeString('2024-01-01T12:00:00.000Z');
  const propagator = new KeplerPropagator(createLeoOrbit(startEpoch));
  const sensor = createSensor('eastCoast');
...
describe('BatchLeastSquaresOD - Numerical Stability', () => {
...
/*
 * ============================================================================
 * Test Suite: Constructor and Configuration
 * ============================================================================
 */

describe('BatchLeastSquaresOD - Constructor and Configuration', () => {
  const startEpoch = EpochUTC.fromDateTimeString('2024-01-01T12:00:00.000Z');
  const propagator = new KeplerPropagator(createLeoOrbit(startEpoch));
  const sensor = createSensor('eastCoast');
...
/*
 * ============================================================================
 * Test Suite: fastDerivatives Flag
 * ============================================================================
 */

describe('BatchLeastSquaresOD - fastDerivatives Flag', () => {
  const startEpoch = EpochUTC.fromDateTimeString('2024-01-01T12:00:00.000Z');
  const propagator = new KeplerPropagator(createLeoOrbit(startEpoch));
  const sensor = createSensor('eastCoast');

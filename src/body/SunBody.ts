...
import { Degrees, Kilometers, Meters, Radians, Seconds } from '../types/types';
import { cKmPerSec, DEG2RAD, MS_PER_DAY } from '../utils/constants';
...
import { SunTime } from '../types/types';

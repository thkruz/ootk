...
export class Sgp4 {
  ...
  static propagate(satrec: SatelliteRecord, tsince: number): StateVectorSgp4 {
    ...
    const r = {
      x: mrt * ux * satrec.radiusearthkm as Kilometers,
      y: mrt * uy * satrec.radiusearthkm as Kilometers,
      z: mrt * uz * satrec.radiusearthkm as Kilometers,
    };
    const v = {
      x: (mvt * ux + rvdot * vx) * vkmpersec as KilometersPerSecond,
      y: (mvt * uy + rvdot * vy) * vkmpersec as KilometersPerSecond,
      z: (mvt * uz + rvdot * vz) * vkmpersec as KilometersPerSecond,
    };

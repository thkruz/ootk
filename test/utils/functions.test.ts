...
describe('dopplerFactor', () => {
  it('should calculate doppler factor', () => {
    const location = { x: 6378, y: 0, z: 0 } as EcfVec3<Kilometers>;
    const position = { x: 42164, y: 0, z: 0 } as EcfVec3<Kilometers>;
    const velocity = { x: 0, y: 3.075, z: 0 } as EcfVec3<KilometersPerSecond>;
